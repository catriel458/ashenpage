    ...
    <main className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-5">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/comunidad"
            className="text-xs tracking-widest uppercase text-zinc-500 hover:text-white transition-colors duration-300 px-4 py-2"
          >
            Comunidad
          </Link>
          <Link
      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-8 py-32">
          <div className="max-w-xl">
            <p className="text-xs tracking-[0.4em] uppercase text-zinc-500 mb-6">Para escritores de lo oscuro</p>
            ...
            <div className="flex items-center gap-4">
              <Link href="/login" className="bg-white text-black px-8 py-3 rounded-full text-sm font-semibold hover:bg-zinc-200 transition-colors duration-300 tracking-wide">
                Empezar gratis
              </Link>
      ...
      <section className="relative z-10 bg-black border-t border-zinc-900 px-8 py-24">
        <div className="max-w-5xl mx-auto">
          <p className="text-xs tracking-[0.4em] uppercase text-zinc-600 mb-16 text-center">Todo lo que necesitás para escribir</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-zinc-900">
            {[
              { icon: "◈", title: "La Biblia", description: "Definí personajes, lugares y las reglas de tu universo. La IA los recuerda y los usa." },
              { icon: "◎", title: "IA Contextual", description: "No un chatbot genérico. Una IA que conoce tu historia y escribe en tu tono." },
              { icon: "◉", title: "Editor Limpio", description: "Sin distracciones. Solo vos y tu historia. Guardado automático siempre." },
            ].map((feature) => (
              <div key={feature.title} className="bg-black p-8 flex flex-col gap-4 hover:bg-zinc-950 transition-colors duration-300">
      ...
      <section className="relative z-10 bg-black border-t border-zinc-900 px-8 py-24">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center gap-6">
          ...
          <Link href="/login" className="bg-white text-black px-8 py-3 rounded-full text-sm font-semibold hover:bg-zinc-200 transition-colors duration-300 tracking-wide mt-4">
